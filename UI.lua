...
ui.IgnoreGuiInset = true -- Better for mobile compatibility
...
local function CreateLoadingScreen()
    ...
    Spinner.Rotation = 0
    Spinner.Visible = false -- Only show if taking long, keeping it clean
    ...
    -- Wait a bit to show off the screen
    task.wait(1.5)
...
-- // Draggable Function (Updated for Mobile)
...
function lib:Window(text, preset, closebind)
    ...
    local fs = false -- First tab state
    ...
    Main.BackgroundColor3 = Color3.fromRGB(20, 20, 20) -- Darker background
    ...
    function lib:Notification(texttitle, textdesc, textbtn)
        ...
        NotificationFrame.Size = UDim2.new(0, 0, 0, 0) -- Start small
    ...
    function tabhold:Tab(text)
        ...
        function tabcontent:Toggle(text,default, callback)
            ...
            local ToggleOuter = Instance.new("Frame") -- Container
            local ToggleInner = Instance.new("Frame") -- The dot
        ...
        function tabcontent:Slider(text, min, max, start, callback)
            ...
            -- Allow clicking anywhere on bar to jump
        ...
        function tabcontent:Dropdown(text, list, callback)
            ...
            DropItemHolder.ClipsDescendants = true -- Prevent visual glitch before tween
            ...
            -- Recalculate Canvas Size for items
